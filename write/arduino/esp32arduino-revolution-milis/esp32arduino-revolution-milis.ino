...
const char* ssid = "TP-Link_CA8E";   // Sostituisci con il nome della tua rete WiFi
const char* password = "22327000"; // Sostituisci con la password della tua rete WiFi
...
void sendData() {
  ...
  valuesObj["x"] = speedLevel;
  //valuesObj["y"] = 2;
  //valuesObj["z"] = 3 + i;
  Serial.println("x :" +speedLevel);
